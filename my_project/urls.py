...
urlpatterns = [
    ...
    # Spheres (LiveKit Audio)
    path('api/spheres/<slug:slug>/status/', users_api.sphere_status_view, name='api-sphere-status'),
    path('api/spheres/<slug:slug>/create/', users_api.sphere_create_view, name='api-sphere-create'),
    path('api/spheres/<slug:slug>/join/', users_api.sphere_join_view, name='api-sphere-join'),
    path('api/spheres/<slug:slug>/leave/', users_api.sphere_leave_view, name='api-sphere-leave'),
    path('api/spheres/<slug:slug>/end/', users_api.sphere_end_view, name='api-sphere-end'),
    path('api/spheres/<slug:slug>/participants/', users_api.sphere_participants_view, name='api-sphere-participants'),
    path('api/spheres/<slug:slug>/hand-raise/', users_api.sphere_hand_raise_view, name='api-sphere-hand-raise'),
    path('api/spheres/<slug:slug>/promote/', users_api.sphere_promote_view, name='api-sphere-promote'),
    path('api/spheres/<slug:slug>/demote/', users_api.sphere_demote_view, name='api-sphere-demote'),
    path('api/spheres/<slug:slug>/request-join/', users_api.sphere_request_join_view, name='api-sphere-request-join'),
    path('api/spheres/<slug:slug>/requests/', users_api.sphere_pending_requests_view, name='api-sphere-requests'),
    path('api/spheres/<slug:slug>/approve/', users_api.sphere_approve_request_view, name='api-sphere-approve'),
    path('api/spheres/<slug:slug>/deny/', users_api.sphere_deny_request_view, name='api-sphere-deny'),
